...
import { handleConvertCurrencies } from '@nx-nextjs/api-services';
    ...
    >
      <Form
        ...
        onSubmit={handleSubmit((value: IConvertCurrencies) =>
          handleConvertCurrencies<IConvertCurrencies>(value, setListSymbols)
        )}
      >
        <Row>
          ...
          <Col sm="12" className="mb-2">
            ...
            <small>
              <b className="bold">REQUIRED</b>:The three-letter currency code of
              the currency you would like to convert from.
            </small>
          </Col>
          <Col sm="12" className="mb-2">
            ...
            <small>
              <b className="bold">REQUIRED</b>:The three-letter currency code of
              the currency you would like to convert to.
            </small>
          </Col>
          <Col sm="12" className="mb-2">
            ...
            <small>
              <b className="bold">REQUIRED</b>:Specify a date (format
              YYYY-MM-DD) to use historical rates for this conversion.
            </small>
          </Col>
          <Col sm="12">
