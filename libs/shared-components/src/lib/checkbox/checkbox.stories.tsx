...
const CheckBoxColorTemplate: ComponentStory<typeof CheckboxColor> = () => <CheckboxColor />;

const BaseCheckBoxTemplate: ComponentStory<typeof BaseCheckBox> = () => <BaseCheckBox />;
