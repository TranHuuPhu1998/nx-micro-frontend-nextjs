...
const ButtonGroupTemplate: ComponentStory<typeof BaseButtonGroup> = (args) => <BaseButtonGroup {...args} />;

const ButtonTemplate: ComponentStory<typeof BaseButton> = (args) => <BaseButton {...args} />;
