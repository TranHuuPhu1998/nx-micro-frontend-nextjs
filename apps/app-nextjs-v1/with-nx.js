...
function getWithNxContext() {
  return {
    workspaceRoot: '/Users/phutran/Documents/package/nx-nextjs',
    libsDir: 'libs',
  };
}
  ...
  return Object.assign(
    ...
    ),
    {
      webpack: (config, options) => {
        ...
        const includes = [require('path').join(context.workspaceRoot, context.libsDir)];
        ...
        if (nextSassLoader && nextSassLoader.issuer) {
          nextSassLoader.issuer.or = nextSassLoader.issuer.and ? nextSassLoader.issuer.and.concat(includes) : includes;
        ...
        const nextGlobalCssLoader = nextCssLoaders.oneOf.find((rule) => {
          var _a, _b;
          return (_b = (_a = rule.include) === null || _a === void 0 ? void 0 : _a.and) === null || _b === void 0
            ? void 0
        ...
        /**
         * 5. Add env variables prefixed with NEXT_PUBLIC_
         */
...
function getNxEnvironmentVariables() {
  return Object.keys(process.env)
    .filter((env) => /^NEXT_PUBLIC_/i.test(env))
    .reduce((env, key) => {
